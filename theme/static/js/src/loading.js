...
export function nextHelpText () {
    ...
    if (text !== null) {
        if (!text.hasClass('longLaunch')) {
            ...
            msg = 'Your session is taking longer than usual to start!<br />Do you already have a server running? <a href="{{ JUPYTERHUB_URL }}/hub/home">Go to the server home page</a> to check.';
        }
        text.html(msg);
    }
}
